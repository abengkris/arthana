...
- [x] Task: Implement Reactive Category Dropdown 859ca04
  - [x] Write failing tests for category dropdown filtering based on the selected transaction type.
  - [x] Update the UI logic in `TransactionForm.tsx` to filter the category list based on the active type ("Pemasukan" vs "Pengeluaran").
