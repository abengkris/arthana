...
- [ ] **Task 2: Generate SQL script for strict RLS policies**
    ...
    - [ ] Create policies for `SELECT`, `INSERT`, `UPDATE`, and `DELETE` where `user_id = auth.uid()`
- [ ] **Task 3: Conductor - User Manual Verification 'Database Setup' (Protocol in workflow.md)**
